...
public class CachedLinkedMapLruFieldConfigHelper implements FieldConfigHelper {
    ...
    public CachedLinkedMapLruFieldConfigHelper(FieldConfigHelper helper, int limit) {
        if (limit < 1) {
